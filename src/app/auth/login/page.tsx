...
const LoginPage = () => {
  ...
  const handleBitrixSignIn = async() => {
    ...
    const clientId = "local.67ff193ff2cbc9.59883640"; // Use your actual client ID
    ...
    router.push("https://syntactics.bitrix24.com/oauth/authorize/?client_id=local.67ff193ff2cbc9.59883640&current_fieldset=SOCSERV");
  };
